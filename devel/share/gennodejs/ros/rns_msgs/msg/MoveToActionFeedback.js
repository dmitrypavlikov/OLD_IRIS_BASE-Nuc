...
class MoveToActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new MoveToFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = MoveToFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MoveToActionFeedback(null);
    ...
    data.feedback = MoveToFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += MoveToFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MoveToActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = MoveToFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new MoveToFeedback()
    }
...
module.exports = MoveToActionFeedback;
