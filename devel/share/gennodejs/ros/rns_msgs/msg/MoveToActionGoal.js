...
class MoveToActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = MoveToGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += MoveToGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MoveToActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = MoveToGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new MoveToGoal()
    }
...
module.exports = MoveToActionGoal;
