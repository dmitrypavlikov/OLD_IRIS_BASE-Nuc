...
class MoveToActionResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = MoveToResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MoveToActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = MoveToResult.Resolve(msg.result)
    }
    else {
      resolved.result = new MoveToResult()
    }
...
module.exports = MoveToActionResult;
