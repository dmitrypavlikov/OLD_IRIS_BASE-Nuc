...
(cl:defmethod cl:initialize-instance :after ((m <RangeArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RangeArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rns_msgs-msg:<RangeArray> is deprecated: use rns_msgs-msg:RangeArray instead.")))

(cl:ensure-generic-function 'ranges-val :lambda-list '(m))
(cl:defmethod ranges-val ((m <RangeArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rns_msgs-msg:ranges-val is deprecated.  Use rns_msgs-msg:ranges instead.")
  (ranges m))
