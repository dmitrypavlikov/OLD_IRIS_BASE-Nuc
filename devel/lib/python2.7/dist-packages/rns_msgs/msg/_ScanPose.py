...
"""autogenerated by genpy from rns_msgs/ScanPose.msg. Do not edit."""
import sys
...
class ScanPose(genpy.Message):
  _md5sum = "4bdf1e73883144ec23168a493307b70f"
  _type = "rns_msgs/ScanPose"
  _has_header = True #flag to mark the presence of a Header object
  _full_text = """# Header for timestamp
Header header 					
# Laser scan
...
float64 w
"""
  __slots__ = ['header','scan','pose']
  _slot_types = ['std_msgs/Header','sensor_msgs/LaserScan','geometry_msgs/PoseStamped']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ScanPose, self).__init__(*args, **kwds)
