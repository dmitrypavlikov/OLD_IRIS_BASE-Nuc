...
"""autogenerated by genpy from rns_msgs/MapContents.msg. Do not edit."""
import sys
...
class MapContents(genpy.Message):
  _md5sum = "7df6b4424f17cea740a310413f98541b"
  _type = "rns_msgs/MapContents"
...
"""
  __slots__ = ['header','info','pages']
  _slot_types = ['std_msgs/Header','rns_msgs/MapInfo','rns_msgs/MapPage[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MapContents, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.header is None:
        self.header = std_msgs.msg.Header()
      if self.info is None:
        self.info = rns_msgs.msg.MapInfo()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2if3i7d().pack(_x.info.width, _x.info.height, _x.info.resolution, _x.info.pageSize, _x.info.pageDim, _x.info.numPages, _x.info.origin.position.x, _x.info.origin.position.y, _x.info.origin.position.z, _x.info.origin.orientation.x, _x.info.origin.orientation.y, _x.info.origin.orientation.z, _x.info.origin.orientation.w))
      length = len(self.pages)
      buff.write(_struct_I.pack(length))
      for val1 in self.pages:
        _x = val1
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.info.width, _x.info.height, _x.info.resolution, _x.info.pageSize, _x.info.pageDim, _x.info.numPages, _x.info.origin.position.x, _x.info.origin.position.y, _x.info.origin.position.z, _x.info.origin.orientation.x, _x.info.origin.orientation.y, _x.info.origin.orientation.z, _x.info.origin.orientation.w,) = _get_struct_2if3i7d().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.pages = []
