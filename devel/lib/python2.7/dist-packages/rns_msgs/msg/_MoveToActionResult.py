...
"""autogenerated by genpy from rns_msgs/MoveToActionResult.msg. Do not edit."""
import sys
...
class MoveToActionResult(genpy.Message):
  _md5sum = "233ebd43e048a55d1a3b0a2f47cc47c3"
  _type = "rns_msgs/MoveToActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','rns_msgs/MoveToResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = rns_msgs.msg.MoveToResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = rns_msgs.msg.MoveToResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_fB().pack(_x.result.distanceError, _x.result.complete))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.distanceError, _x.result.complete,) = _get_struct_fB().unpack(str[start:end])
