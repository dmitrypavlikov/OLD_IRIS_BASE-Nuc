...
"""autogenerated by genpy from rns_msgs/AnnotationUpdate.msg. Do not edit."""
import sys
...
class AnnotationUpdate(genpy.Message):
  _md5sum = "80f10fdd382829c5ed2b38f9c244c413"
  _type = "rns_msgs/AnnotationUpdate"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# Message contains annotation update
...
"""
  ...
  __slots__ = ['annotations','action','revision','updated']
  _slot_types = ['rns_msgs/Annotation[]','int32','int64','int64[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       annotations,action,revision,updated
    ...
    """
    if args or kwds:
      super(AnnotationUpdate, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_iq().pack(_x.action, _x.revision))
      length = len(self.updated)
      buff.write(_struct_I.pack(length))
      pattern = '<%sq'%length
      buff.write(struct.pack(pattern, *self.updated))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action, _x.revision,) = _get_struct_iq().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sq'%length
      ...
      self.updated = struct.unpack(pattern, str[start:end])
      return self
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sq'%length
      buff.write(self.updated.tostring())
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.updated = numpy.frombuffer(str[start:end], dtype=numpy.int64, count=length)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e) #most likely buffer underfill
